...
from diffusersm import (DDPMScheduler,
...
def log_validation(vae, unet, controlnet, args, acclerator, weight_dtype, step, is_final_validation=False):
    logger.info("Running validation...")
    
    if not is_final_validation:
        controlnet = acclerator.unwrap(controlnet)
        pipeline = None
